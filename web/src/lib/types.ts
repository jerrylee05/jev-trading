...
export interface BlockEvent {
  ...
  /** Top of book, best first: [price, size]. Absent on older snapshots. */
...
export interface Meta {
  ...
  market: string;
  startedAt: number;
  /** Present when the trader snapshot includes BANKROLL_USD. */
  bankrollUsd?: number;
  /** Present when the trader snapshot includes HORIZON_BLOCKS. */
